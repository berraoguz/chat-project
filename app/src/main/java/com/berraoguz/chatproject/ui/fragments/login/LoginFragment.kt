package com.berraoguz.chatproject.ui.fragments.login
...
import com.berraoguz.chatproject.databinding.FragmentLoginBinding
import com.berraoguz.chatproject.ui.alertdialog.LoadingAlertDialog
import com.berraoguz.chatproject.ui.presenter.FirebaseAuthLoginPresenter
import com.berraoguz.chatproject.ui.viewModel.LoginViewModel
...
class LoginFragment : Fragment(), FirebaseAuthLoginPresenter {
    ...
    private fun showSnackBarSendVerify() {
        val snackBar = Snackbar.make(
            requireContext(),
            requireView(),
            "You should verify your account to able to sign in chat project app",
